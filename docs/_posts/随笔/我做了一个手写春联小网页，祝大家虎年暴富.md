  ...
  <div class="wrap" :class="'mode-' + mode" @touchstart="handleTouchstart">
    ...
    <div v-if="isReadImages">
      ...
      <img
        ...
        class="hide-img"
        id="qrcode"
        src="https://jsd.cdn.zzko.cn/gh/friedy37/image_store2@master/img/qrcode.zul0pldsuao.png"
      />
    </div>

    <!-- 背景音乐 -->
    <audio
      src="https://jsd.cdn.zzko.cn/gh/friedy37/image_store2@master/cjxq.mp3"
      id="bgm"
      ref="bgm"
      loop
    />
...
export default {
  ...
  data() {
    return {
      ...
      bgList: [
        'https://jsd.cdn.zzko.cn/gh/friedy37/image_store@master/1.4j8qpdnq80i0.jpeg',
        'https://jsd.cdn.zzko.cn/gh/friedy37/image_store@master/4.4460an8ag5o0.jpeg',
        'https://jsd.cdn.zzko.cn/gh/friedy37/image_store@master/5.3axtl4xpvy00.jpeg',
        'https://jsd.cdn.zzko.cn/gh/friedy37/image_store@master/6.2lnbphdqjaq0.jpeg',
      ],
